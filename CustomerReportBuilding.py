...
class Report:
    ...
    def mysqldata(self, log_name, dict_data):
        ...
        val_eol = (
        (None,log_name[5:25], 'Sleep Power Current Measure', dict_data['Sleep Power Current Measure'], 'PASS', now),
        (None,log_name[5:25], 'Standby Power Current Measure', dict_data['Standby Power Current Measure'], 'PASS', now),
        (None, log_name[5:25], 'Read FTEAEXC_UResExcAvg', dict_data['Read FTEAEXC_UResExcAvg'], 'PASS', now),
        (None, log_name[5:25], 'Read MAIN_VSIRxsGridVoltW', dict_data['Read MAIN_VSIRxsGridVoltW'], 'PASS', now),
        (None, log_name[5:25], 'Read T_Iuvw3_U16[0]', dict_data['Read T_Iuvw3_U16[0]'], 'PASS', now),
        (None, log_name[5:25], 'Read T_Iuvw3_U16[1]', dict_data['Read T_Iuvw3_U16[1]'], 'PASS', now),
        (None, log_name[5:25], 'Read T_Iuvw3_U16[2]', dict_data['Read T_Iuvw3_U16[2]'], 'PASS', now),
        (None, log_name[5:25], 'Read FS_IbatHV_U16', dict_data['Read FS_IbatHV_U16'], 'PASS', now),
        (None, log_name[5:25], 'Read HV_FS_FaultLevel_U16', dict_data['Read HV_FS_FaultLevel_U16'], 'PASS', now),
        (None, log_name[5:25], 'Read FSEABHV_UbatHV', dict_data['Read FSEABHV_UbatHV'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMAPMT_PmTemp', dict_data['Read FSMAPMT_PmTemp'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMADBT_DboardTemp', dict_data['Read FSMADBT_DboardTemp'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMACBT_CboardTempHV', dict_data['Read FSMACBT_CboardTempHV'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMACBT_CboardTempLV', dict_data['Read FSMACBT_CboardTempLV'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMAICT_CoolingTemp', dict_data['Read FSMAICT_CoolingTemp'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMAMST_StatorTemp1', dict_data['Read FSMAMST_StatorTemp1'], 'PASS', now),
        (None, log_name[5:25], 'Read FSMAMST_StatorTemp2', dict_data['Read FSMAMST_StatorTemp2'], 'PASS', now),
        (None, log_name[5:25], 'Resolver excitation', dict_data['Resolver excitation'], 'PASS', now),
        (None, log_name[5:25], 'Read FT_ResolverSin_U16 Max', dict_data['Read FT_ResolverSin_U16 Max'], 'PASS', now),
        (None, log_name[5:25], 'Read FT_ResolverSin_U16 Min', dict_data['Read FT_ResolverSin_U16 Min'], 'PASS', now),
        (None, log_name[5:25], 'Read FT_ResolverCos_U16 Max', dict_data['Read FT_ResolverCos_U16 Max'], 'PASS', now),
        (None, log_name[5:25], 'Read FT_ResolverCos_U16 Min', dict_data['Read FT_ResolverCos_U16 Min'], 'PASS', now),
        (None, log_name[5:25], 'Switch Measure Current', dict_data['Switch Measure Current'], 'PASS', now),
        (None, log_name[5:25], 'Active discharge time', dict_data['Active discharge 450V to 60V'], 'PASS', now),
        (None, log_name[5:25], 'Passive discharge time', dict_data['Passive discharge 450V to 60V'], 'PASS', now),
        (None, log_name[5:25], 'Read Dcs_bMot Current', dict_data['Read Dcs_bMot Measure Current'], 'PASS', now),
        (None, log_name[5:25], 'Read Pls_bMot Current', dict_data['Read Pls_bMot Measure Current'], 'PASS', now),
        (None, log_name[5:25], 'Read Interlock status', dict_data['Read MAIN_MSGu8InverterHVILStatus'], 'PASS', now),
        (None, log_name[5:25], 'FSMABLV_UbatLVCorGainC', dict_data['Read FSMABLV_UbatLVCorGainC'], 'PASS', now),
        (None, log_name[5:25], 'FSMABLV_UbatLVCorOffsetC', dict_data['Read FSMABLV_UbatLVCorOffsetC'], 'PASS', now),
        (None, log_name[5:25], 'HV_CorGainC', dict_data['Read HV_CorGainC'], 'PASS', now),
        (None, log_name[5:25], 'HV_CorOffsetC', dict_data['Read HV_CorOffsetC'], 'PASS', now),
        (None, log_name[5:25], 'FTEAMPI_A2DGainIsuLC', dict_data['Read FTEAMPI_A2DGainIsuLC'], 'PASS', now),
        (None, log_name[5:25], 'FTEAMPI_A2DGainIsvLC', dict_data['Read FTEAMPI_A2DGainIsvLC'], 'PASS', now),
        (None, log_name[5:25], 'FTEAMPI_A2DGainIswLC', dict_data['Read FTEAMPI_A2DGainIswLC'], 'PASS', now),
        (None, log_name[5:25], 'SAMTLCS_A2DGainIsuLC', dict_data['Read SAMTLCS_A2DGainIsuLC'], 'PASS', now),
        (None, log_name[5:25], 'SAMTLCS_A2DGainIsvLC', dict_data['Read SAMTLCS_A2DGainIsvLC'], 'PASS', now),
        (None, log_name[5:25], 'SAMTLCS_A2DGainIswLC', dict_data['Read SAMTLCS_A2DGainIswLC'], 'PASS', now))
